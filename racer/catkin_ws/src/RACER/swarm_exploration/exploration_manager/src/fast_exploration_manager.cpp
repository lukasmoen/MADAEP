...
void FastExplorationManager::initialize(ros::NodeHandle& nh) {
  ...
  next_pos_marker_pub_ = nh.advertise<visualization_msgs::Marker>("/next_view", 10);
...
void FastExplorationManager::publishNextPosMarker(const Eigen::Vector3d& next_pos) {
  visualization_msgs::Marker marker;
  marker.header.frame_id = "world";  // Set your frame ID
  ...
  next_pos_marker_pub_.publish(marker);
}
