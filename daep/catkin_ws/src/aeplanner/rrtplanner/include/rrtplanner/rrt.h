...
class Rrt
{
  public:
    ...
    void agentPoseCallback(const nav_msgs::Odometry& model_states);
    void agentPoseCallback2(const sensor_msgs::PointCloud2& model_states);
  ...
  private:
    ...
    ros::Subscriber octomap_sub_,octomap_sub_2,octomap_sub_3;
